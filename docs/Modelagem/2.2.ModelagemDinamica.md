...
# Introdução
Esste documento apresenta flucxos do sistema FCTEpodcast, por meio de diagramas de atividade. Os diagramas descritos incluem interações típicas dos usuários, como login, criação de conta e gestão de podcasts, além dos comportamentos específicos dos perfis Aluno, Professor e Usuário Geral dentro da plataforma. O objetivo é ilustrar graficamente os processos e facilitar o entendimento do funcionamento do sistema.
